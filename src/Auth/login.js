...
const [username, setUserName] = useState("");
  ...
  if(localusername =="desk" && localpassword=="desk@123"){
...
// Make a POST request to log in the user
 function SignIn(){
  ...
  if(username =="desk" && password=="desk@123")
  {
    localStorage.setItem("username","desk");
    localStorage.setItem("password","desk@123");
    history.push("/institutepage");
  }
  else
